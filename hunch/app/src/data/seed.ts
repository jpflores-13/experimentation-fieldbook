...
export const concepts: Concept[] = [
  {
    ...
    icon: 'SneakerMove', accent: 'blue', step: 4, stepLabel: 'Step 4 · Prototype',
  ...
  },
  {
    ...
    icon: 'HandWaving', accent: 'teal', step: 5, stepLabel: 'Step 5 · Trial',
  ...
  },
  {
    ...
    icon: 'CompassTool', accent: 'blue', step: 3, stepLabel: 'Step 3 · Test design',
  ...
  },
  {
    ...
    icon: 'FirstAid', accent: 'slate', step: 2, stepLabel: 'Step 2 · Evidence',
  ...
  },
  {
    ...
    icon: 'Lightning', accent: 'slate', step: 1, stepLabel: 'Step 1 · Frame',
  ...
  },
  {
    ...
    icon: 'Users', accent: 'slate', step: 1, stepLabel: 'Step 1 · Frame',
