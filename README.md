...
2. **[Hunch](hunch/)** — the same five-step product, rebranded, plus a
   **Systems maps** workspace (Support Map, Feedback Loops, Archetypes) for
   understanding the system an idea lives in before testing it. See
   [`hunch/README.md`](hunch/README.md).
